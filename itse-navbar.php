 ...
 * Description: Replaces any WordPress header with a modern Dynamic Island floating ITSE navbar, offer bar, WooCommerce/FunnelKit cart icon, profile icon, separate desktop/mobile menus, mobile accordion submenus, GTranslate language selector popover, and GitHub automatic update checker.
 * Version:     1.5.0
 * Author:      ITSE
...
define( 'ITSE_NAVBAR_VERSION', '1.5.0' );
