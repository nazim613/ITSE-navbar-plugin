 ...
 * Description: Replaces any WordPress header with a modern Dynamic Island floating ITSE navbar, offer bar, WooCommerce/FunnelKit cart icon, profile icon, separate desktop/mobile menus, and GitHub automatic update checker.
 * Version:     1.0.0
 * Author:      ITSE
...
define( 'ITSE_NAVBAR_VERSION', '1.0.0' );
