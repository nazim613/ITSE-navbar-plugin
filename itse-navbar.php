 ...
 * Description: Replaces any WordPress header with a modern Dynamic Island floating ITSE navbar, offer bar, WooCommerce/FunnelKit cart icon, profile icon, separate desktop/mobile menus, mobile accordion submenus, direct GTranslate language shortcode output, and GitHub automatic update checker.
 * Version:     1.6.0
 * Author:      ITSE
...
define( 'ITSE_NAVBAR_VERSION', '1.6.0' );
